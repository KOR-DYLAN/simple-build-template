...
ldflags-$(CONFIG_ENV_BAREMETAL)		+=-Wl,--fatal-warnings
ldflags-$(CONFIG_ENV_BAREMETAL)		+=-Wl,--gc-sections
ldflags-$(CONFIG_ENV_BAREMETAL)		+=-Wl,--sort-section=alignment
ldflags-$(CONFIG_ENV_BAREMETAL)		+=-Wl,-z,common-page-size=4096
ldflags-$(CONFIG_ENV_BAREMETAL)		+=-Wl,-z,max-page-size=4096
ldflags-$(CONFIG_ENV_BAREMETAL)		+=-Wl,--build-id=none
